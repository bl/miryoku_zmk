...
// Layer 0: Swapping Backspace & space on ColelmakDH (with timeless HRMs)
// Original Miryoku homerow (tap-preferred, 200ms):
...
// Layer 1: Swapping Backspace & space on QWERTY base (with timeless HRMs)
// Original Miryoku homerow (tap-preferred, 200ms):
...
U_LT(U_BUTTON, Z), &hml RALT X,       &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         &hmr RALT DOT,     U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, BSPC),U_LT(U_MOUSE, TAB),U_LT(U_SYM, RET),  U_LT(U_NUM, SPACE), U_LT(U_FUN, DEL),  U_NP,              U_NP
